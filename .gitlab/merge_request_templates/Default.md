...
Describe what this MR does and why. Include relevant context for reviewers.
...
- [ ] The change does what the summary claims
- [ ] All new code has appropriate test coverage
- [ ] No secrets, credentials, or personally identifiable information are present
- [ ] Public APIs and functions have docstrings or JSDoc
- [ ] CI pipeline passes for all stages
- [ ] The implementation addresses the root cause rather than a symptom
